...
class Module(Base):
    ...
    remote_url = Column(String, nullable=False)   # URL pública (browser)
    api_url = Column(String, nullable=False)       # URL pública (browser)
    health_url = Column(String, nullable=True)     # URL interna Docker (health check)
